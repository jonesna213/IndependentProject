...
<c:set var="title" value="Edit Bill" />
<c:if test="${user == null}" >
    ...
    <body>
        <div class="container">
            ...
            <div class="w-75 mx-auto">
                <h2 class="text-decoration-underline">Edit Bill</h2>
                <c:if test="${error != null}" >
                    <c:if test="${error == true}" >
                        <h3 class="text-danger">Failed to edit bill, please try again</h3>
                        <p>${message}</p>
                    </c:if>
                    <c:if test="${error == false}" >
                        <h3 class="text-success">Bill Edit was successful</h3>
                    </c:if>
                ...
                <form action="editBillServlet" method="post">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control"
                               name="title" id="title"
                               value="${billToEdit.title}"
                               required/>
                    </div>
                    <div class="form-group my-3">
                        <label for="description" class="fw-bold">Description/Website to pay</label>
                        <p><em>(Optional)</em></p>
                        <textarea name="description" class="form-control" id="description">${billToEdit.description}</textarea>
                    </div>
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control"
                               ...
                               value="${billToEdit.dueDate}">
                    </div>
                    <div class="form-group my-3">
                        <label for="amount" class="fw-bold">Amount</label>
                        <input type="text" class="form-control"
                               name="amount" id="amount" value="${billToEdit.amount}">
                    </div>
                    <fieldset class="my-3">
                        ...
                        <div class="form-check">
                            <label for="once" class="form-check-label">
                                ...
                                <c:if test="${billToEdit.frequency == 'once'}" >
                                       checked
                                </c:if> required>
                                Once
                            </label>
                        ...
                        <div class="form-check">
                            <label for="weekly" class="form-check-label">
                                ...
                                <c:if test="${billToEdit.frequency == 'weekly'}" >
                                       checked
                                </c:if>>
                                Weekly
                            </label>
                        ...
                        <div class="form-check">
                            <label for="monthly" class="form-check-label">
                                ...
                                <c:if test="${billToEdit.frequency == 'monthly'}" >
                                       checked
                                </c:if>>
                                Monthly
                            </label>
